<?php
/**
 * Ridez WooCommerce Adjacent Products Class
 *
 * @package  ridez
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Ridez_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Ridez WooCommerce Adjacent Products Class
	 */
	class Ridez_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'ridez_woocommerce_adjacent_query_args', $args ) );
