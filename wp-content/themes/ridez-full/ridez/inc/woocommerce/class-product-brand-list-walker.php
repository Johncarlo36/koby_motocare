<?php
/**
 * Ridez_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Ridez_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Ridez_Product_Brand_List_Walker', false)) :

	class Ridez_Product_Brand_List_Walker extends Walker {
