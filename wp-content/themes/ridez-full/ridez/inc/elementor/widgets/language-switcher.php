...
class Ridez_Elementor_Language_Switcher extends Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'ridez-language-switcher';
    }
    ...
    public function get_title() {
        return esc_html__('Language Switcher', 'ridez');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'typography',
                'selector' => '{{WRAPPER}} .ridez-language-switcher span.title',
            ]
        );
        ...
        $this->add_control(
            'label_color',
            [
                'label'     => esc_html__('Label Color', 'ridez'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .ridez-language-switcher .item > div i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hover_right',
            [
                'label'        => esc_html__('Hover Right', 'ridez'),
    ...
    protected function render() {
        ridez_language_switcher();
    }
}

$widgets_manager->register(new Ridez_Elementor_Language_Switcher());
