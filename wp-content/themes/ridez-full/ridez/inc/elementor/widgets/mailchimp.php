...
if (!ridez_is_mailchimp_activated()) {
    return;
}
...
class Ridez_Elementor_Mailchimp extends Elementor\Widget_Base {

    public function get_name() {
        return 'ridez-mailchmip';
    }

    public function get_title() {
        return esc_html__('MailChimp Sign-Up Form', 'ridez');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'layout-1',
                'prefix_class' => 'elementor-mailchip-',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Placeholder', 'ridez'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Icon Border Color hover', 'ridez'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Ridez_Elementor_Mailchimp());
