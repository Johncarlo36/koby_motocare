...
class Ridez_Elementor_Testimonials extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Ridez Testimonials', 'ridez');
    }
    ...
    public function get_script_depends() {
        return ['ridez-elementor-testimonial', 'slick'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => esc_html__('Testimonials', 'ridez'),
            ]
        );
        ...
        $repeater->add_control(
            'testimonial_rating',
            [
                'label'   => esc_html__('Rating', 'ridez'),
                'default' => 5,
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    0 => esc_html__('Hidden', 'ridez'),
                    1 => esc_html__('Very poor', 'ridez'),
                    2 => esc_html__('Not that bad', 'ridez'),
                    3 => esc_html__('Average', 'ridez'),
                    4 => esc_html__('Good', 'ridez'),
                    5 => esc_html__('Perfect', 'ridez'),
                ]
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            'testimonials_image_position',
            [
                'label' => esc_html__( 'Image Position', 'ridez' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'aside',
                'options' => [
                    'aside' => esc_html__( 'Aside', 'ridez' ),
        ...
        $this->add_control(
            'testimonials_content_position',
            [
                'label' => esc_html__( 'Content Position', 'ridez' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'aside',
                'options' => [
                    'aside' => esc_html__( 'Aside', 'ridez' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'prefix_class' => 'testimonials-alignment-',
                'selectors' => [
                    '{{WRAPPER}} .elementor-testimonial-item .inner' => 'text-align: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'testimonial_size_image',
            [
                'label' => esc_html__( 'Image Size', 'ridez' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-testimonial-images-position-top .elementor-testimonial-image' => 'padding-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .elementor-testimonial-images-position-aside .elementor-testimonial-image' => 'padding-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} elementor-testimonial-content-position-top .content' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} elementor-testimonial-content-position-aside .content' => 'margin-top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        if (!empty($settings['testimonials']) && is_array($settings['testimonials'])) {
            ...
            $this->add_render_attribute('details', 'class', 'elementor-testimonial-details');

            $this->add_render_attribute('caption', 'class', 'testimonial-caption');

            if ( $settings['testimonials_image_position'] ) {
                $this->add_render_attribute( 'caption', 'class', 'elementor-testimonial-images-position-' . $settings['testimonials_image_position'] );
            }

            $this->add_render_attribute('content', 'class', 'testimonial-content');
            if ( $settings['testimonials_content_position'] ) {
                $this->add_render_attribute( 'content', 'class', 'elementor-testimonial-content-position-' . $settings['testimonials_content_position'] );
            }
                    ...
                    <?php foreach ($settings['testimonials'] as $testimonial): ?>
                        <div <?php echo ridez_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="inner">
                                ...
                                <div <?php echo ridez_elementor_get_render_attribute_string('content', $this); // WPCS: XSS ok. ?>>
                                    ...
                                    <?php endif; ?>
                                    <div <?php echo ridez_elementor_get_render_attribute_string('caption', $this); // WPCS: XSS ok. ?>>
                                        <div class="testimonial-caption-inner">
                                            <?php $this->render_image($settings, $testimonial); ?>
                                            <div <?php echo ridez_elementor_get_render_attribute_string('details', $this); // WPCS: XSS ok. ?>>
                                                <?php
...
$widgets_manager->register(new Ridez_Elementor_Testimonials());
