...
class Ridez_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Brands', 'ridez');
    }
    ...
    public function get_script_depends() {
        return ['ridez-elementor-brand', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'ridez'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'ridez'),
                'placeholder' => esc_html__('Brand Name', 'ridez'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'border_style',
            [
                'label'        => esc_html__('Border', 'ridez'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => '',
                'prefix_class' => 'ridez-brand-border-'
            ]
        );
                        ...
                        <div <?php echo ridez_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . ridez_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
...
$widgets_manager->register(new Ridez_Elementor_Brand());
