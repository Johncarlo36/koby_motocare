...
class Ridez_Video_Popup extends Elementor\Widget_Base {

    public function get_name() {
        return 'ridez-video-popup';
    }

    public function get_title() {
        return esc_html__('Ridez Video Popup', 'ridez');
    }
    ...
    public function get_script_depends() {
        return ['ridez-elementor-video', 'jquery-magnific-popup'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__('Support video from Youtube and Vimeo', 'ridez'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Tile', 'ridez'),
                'default'     => '',
            ]
        );
        ...
        $this->add_control(
            'icon_font',
            [
                'label'       => esc_html__('Icon Font', 'ridez'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ridez-video-popup .elementor-video-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ridez-video-popup .elementor-video-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ridez-video-popup .elementor-video-icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ridez-video-popup :hover .elementor-video-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ridez-video-popup :hover .elementor-video-icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ridez-video-popup :hover .elementor-video-icon' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ridez-video-popup :hover .elementor-video-icon',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ridez-video-popup .elementor-video-icon',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .ridez-video-popup .elementor-video-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .ridez-video-popup .elementor-video-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .ridez-video-popup .elementor-video-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ridez-video-popup .elementor-video-title',
            ]
        );
        ...
        $this->add_control(
            'show_title_block',
            [
                'label'     => esc_html__('Style Block', 'ridez'),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => esc_html__('Off', 'ridez'),
                'label_on'  => esc_html__('On', 'ridez'),
                'selectors' => [
                    '{{WRAPPER}} .ridez-video-popup .elementor-video-popup' => 'flex-direction: column;',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute('wrapper', 'class', 'ridez-video-popup');
        ...
        <div <?php echo ridez_elementor_get_render_attribute_string('wrapper', $this); ?>>
            <a <?php echo ridez_elementor_get_render_attribute_string('button', $this); ?>>
...
$widgets_manager->register(new Ridez_Video_Popup());
