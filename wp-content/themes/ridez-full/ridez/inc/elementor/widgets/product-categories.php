...
/**
 * Elementor Ridez_Elementor_Products_Categories
 * @since 1.0.0
 */
...
class Ridez_Elementor_Products_Categories extends Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'ridez-product-categories';
    }
    ...
    public function get_title() {
        return esc_html__('Product Categories', 'ridez');
    }
    ...
    public function get_script_depends() {
        return ['ridez-elementor-product-categories', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'categories_type',
            [
                'label'   => esc_html__('Type', 'ridez'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'cate_image',
                'options' => [
                    'cate_image' => esc_html__('Image', 'ridez'),
                    'cate_icon'  => esc_html__('Icon', 'ridez'),
                ]
            ]
        );
        ...
        $repeater->add_control(
            'categories_name',
            [
                'label' => esc_html__('Alternate Name', 'ridez'),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Description', 'ridez'),
                'type'  => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '1',
                'options' => [
                    '1' => esc_html__('Layout 1', 'ridez'),
                    '2' => esc_html__('Layout 2', 'ridez'),
                    '3' => esc_html__('Layout 3', 'ridez'),
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            'vertical_alignment',
            [
                'label'        => esc_html__('Vertical Alignment', 'ridez'),
                'type'         => Controls_Manager::CHOOSE,
                'options'      => [
                    'flex-start' => [
                ...
                'selectors'    => [
                    '{{WRAPPER}} .cate_image .cat-title' => 'justify-content: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .ridez-carousel .column-item'          => 'padding-left: calc({{SIZE}}{{UNIT}} / 2); padding-right: calc({{SIZE}}{{UNIT}} / 2);',
                    '{{WRAPPER}} .row'                                  => 'margin-left: calc({{SIZE}}{{UNIT}} / -2); margin-right: calc({{SIZE}}{{UNIT}} / -2);',
                    '{{WRAPPER}}.elementor-product-category-show-border-yes .row'=> 'margin-left: 0;  margin-right: 0;',
                    '{{WRAPPER}}.elementor-product-category-show-border-yes .elementor-categories-item'=> 'padding: {{SIZE}}{{UNIT}};  margin-bottom: 0;',
                    ],
            ]
        );
        ...
        $this->add_control(
            'show_border',
            [
                'label'        => __('Show Border', 'ridez'),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => __('Off', 'ridez'),
                'label_on'     => __('On', 'ridez'),
                'prefix_class' => 'elementor-product-category-show-border-',
        ...
        $this->add_control(
            'layout_bkg_color',
            [
                'label'     => esc_html__('Background', 'ridez'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .product-cat .cat-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .product-cat .product-cat-caption' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'      => [
                    '{{WRAPPER}} .link_category_product, {{WRAPPER}} .link_category_product img' => 'width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .layout-2 .cate_image .link_category_product' => 'flex: 0 0 {{SIZE}}{{UNIT}}; max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'image_max_width',
            [
                'label'          => esc_html__('Max Width', 'ridez'),
                'type'           => Controls_Manager::SLIDER,
                'default'        => [
                    'unit' => '%',
                ],
                ...
                'selectors'      => [
                    '{{WRAPPER}} .link_category_product img' => 'max-width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .layout-2 .cate_image .link_category_product' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            'img_layout_bacground',
            [
                'label'     => esc_html__('Background Color', 'ridez'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cate_image .link_category_product' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .link_category_product img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .cate_image:hover .link_category_product' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .product-cat:hover .link_category_product img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .cate_image .link_category_product' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .cate_image .link_category_product img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .cate_image .link_category_product' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .product-cat .cat-title .cat-title-text',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .product-cat .cat-title-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .product-cat .cat-title-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .product-cat .cat-title-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .product-cat .cat-title-text:hover '             => 'color: {{VALUE}};',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .layout-1 .cate_icon .link_category_product' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .layout-2 .cate_icon .link_category_product' => 'margin-right: {{SIZE}}{{UNIT}}; margin-bottom: 0;',
                    '{{WRAPPER}} .layout-3 .cate_icon .link_category_product' => 'margin-top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}}.vertical-align-flex-end .layout-3 .cate_icon .link_category_product' => 'margin-top: 0; margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .cate_icon .link_category_product i'   => 'font-size: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .cate_icon .link_category_product svg' => 'width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .layout-2 .cate_icon .link_category_product' => '    flex: 0 0 calc({{SIZE}}{{UNIT}} + 10px); max-width: calc({{SIZE}}{{UNIT}} + 10px);',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'      => [
                    '{{WRAPPER}} .cate_icon .link_category_product' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'      => [
                    '{{WRAPPER}} .cate_icon .link_category_product' => 'height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name'      => 'icon_border',
                'selector'  => '{{WRAPPER}} .cate_icon .link_category_product',
                'separator' => '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .cate_icon .link_category_product' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .cate_icon .link_category_product i' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .cate_icon .link_category_product' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .cate_icon:hover .link_category_product i' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .cate_icon:hover .link_category_product' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    protected function render() {
        ...
        <div <?php echo ridez_elementor_get_render_attribute_string('wrapper', $this); // WPCS: XSS ok. ?>>
            <div <?php echo ridez_elementor_get_render_attribute_string('row', $this); // WPCS: XSS ok. ?>>
                ...
                <div <?php echo ridez_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                    <?php if (empty($categorieslist['categories'])) {
                        echo esc_html__('Choose Category', 'ridez');
                        return;
                    }
                ...
                <?php if ($categorieslist['categories_type'] == 'cate_image') { ?>
                    <div class="product-cat cate_image">
                        <?php } else { ?>
                        <div class="product-cat cate_icon">
                            <?php } ?>
                            ...
                            <div class="product-cat-caption">
                                <div class="cat-title">
                                    ...
                                    <div class="cat-info">
                                        <span class="cat-total"><?php echo esc_html($category->count) . ' ' . esc_html__('products', 'ridez'); ?></span>
                                    </div>
...
$widgets_manager->register(new Ridez_Elementor_Products_Categories());
