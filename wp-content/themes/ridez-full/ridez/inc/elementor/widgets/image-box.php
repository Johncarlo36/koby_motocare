 ...
 * @since 1.0.0
 */
class Ridez_Elementor_Image_Box extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Image Box', 'ridez' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_image',
			[
				'label' => esc_html__( 'Image Box', 'ridez' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'ridez' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'middle' => esc_html__( 'Middle', 'ridez' ),
...
$widgets_manager->register(new Ridez_Elementor_Image_Box());