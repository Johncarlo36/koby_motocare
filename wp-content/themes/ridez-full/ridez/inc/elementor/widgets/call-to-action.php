...
class Ridez_Call_To_Action extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Ridez Banner', 'ridez' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Image Resolution', 'ridez' ),
                'default' => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            'graphic_element',
            [
                'label' => esc_html__( 'Graphic Element', 'ridez' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'ridez' ),
                        'icon' => 'eicon-ban',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'ridez' ),
                        'icon' => 'fa fa-picture-o',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'ridez' ),
                        'icon' => 'eicon-star',
                    ],
                ],
                'default' => 'none',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'default' => esc_html__( 'Default', 'ridez' ),
                    'stacked' => esc_html__( 'Stacked', 'ridez' ),
                    'framed' => esc_html__( 'Framed', 'ridez' ),
                ],
                'default' => 'default',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_shape',
            [
                'label' => esc_html__( 'Shape', 'ridez' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'circle' => esc_html__( 'Circle', 'ridez' ),
                    'square' => esc_html__( 'Square', 'ridez' ),
                ],
                'default' => 'circle',
                'condition' => [
                    'icon_view!' => 'default',
        ...
        $this->add_control(
            'subtitle',
            [
                'label' => esc_html__( 'Sub title', 'ridez' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => esc_html__( 'This is the sub title', 'ridez' ),
                'placeholder' => esc_html__( 'Enter your sub title', 'ridez' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'title',
            [
                'label' => esc_html__( 'Title & Description', 'ridez' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => esc_html__( 'This is the heading', 'ridez' ),
                'placeholder' => esc_html__( 'Enter your title', 'ridez' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'ridez' ),
                'placeholder' => esc_html__( 'Enter your description', 'ridez' ),
                'separator' => 'none',
                'rows' => 5,
                'show_label' => false,
            ]
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => esc_html__( 'Title HTML Tag', 'ridez' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => 'H1',
                    'h2' => 'H2',
        ...
        $this->add_control(
            'button',
            [
                'label' => esc_html__( 'Button Text', 'ridez' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            'link_click',
            [
                'label' => esc_html__( 'Apply Link On', 'ridez' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'box' => esc_html__( 'Whole Box', 'ridez' ),
                    'button' => esc_html__( 'Button Only', 'ridez' ),
                ],
                'default' => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label' => esc_html__( 'Stretch', 'ridez' ),
        ...
        $this->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'ridez' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'top' => [
        ...
        $this->add_control(
            'show_bg',
            [
                'label'     => esc_html__( 'Show Bg gradien', 'ridez' ),
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_control(
            'graphic_image_hover',
            [
                'label' => esc_html__( 'Image Effect', 'ridez' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'icon_primary_color',
            [
                'label' => esc_html__( 'Primary Color', 'ridez' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Secondary Color', 'ridez' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_size',
            [
                'label' => esc_html__( 'Icon Size', 'ridez' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 6,
        ...
        $this->add_control(
            'icon_padding',
            [
                'label' => esc_html__( 'Icon Padding', 'ridez' ),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'Horizontal_align',
            [
                'label' => esc_html__( 'Horizontal Align', 'ridez' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => esc_html__( 'Left', 'ridez' ),
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Subtitle', 'ridez' ),
                'separator' => 'before',
                'condition' => [
                    'subtitle!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Hover', 'ridez' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label' => esc_html__( 'Sub title Color', 'ridez' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label' => esc_html__( 'Description Color', 'ridez' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Icon Border Color', 'ridez'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_style_theme',
            [
                'label'        => esc_html__('Button Style', 'ridez'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => '',
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__( 'Hover Effects', 'ridez' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'transformation',
            [
                'label' => esc_html__( 'Hover Animation', 'ridez' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => 'None',
                    'zoom-in' => 'Zoom In',
        ...
        $this->add_control(
            'overlay_color',
            [
                'label' => esc_html__( 'Overlay Color', 'ridez' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'overlay_blend_mode',
            [
                'label' => esc_html__( 'Blend Mode', 'ridez' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => esc_html__( 'Normal', 'ridez' ),
                    'multiply' => 'Multiply',
                    'screen' => 'Screen',
                    'overlay' => 'Overlay',
                    'darken' => 'Darken',
        ...
        $this->add_control(
            'effect_duration',
            [
                'label' => esc_html__( 'Transition Duration', 'ridez' ),
                'type' => Controls_Manager::SLIDER,
    ...
    protected function render() {
        ...
        ?>
        <<?php echo esc_html($wrapper_tag) . ' ' . ridez_elementor_get_render_attribute_string( 'wrapper', $this ); ?> class="elementor-cta--skin-cover elementor-cta elementor-ridez-banner">
        <?php if ( $print_bg ) : ?>
            <div class="elementor-cta__bg-wrapper">
                <div class="elementor-cta__bg elementor-bg" <?php echo ridez_elementor_get_render_attribute_string( 'background_image', $this ); ?>></div>
        ...
        <?php if ( $print_content ) : ?>
            ...
            <?php if ( 'image' === $settings['graphic_element'] && ! empty( $settings['graphic_image']['url'] ) ) : ?>
                <div <?php echo ridez_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                ...
                <div <?php echo ridez_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                    <div class="elementor-icon">
                        <?php if ( $is_new || $migrated ) :
                            ...
                            <i <?php echo ridez_elementor_get_render_attribute_string( 'icon', $this ); ?>></i>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $settings['subtitle'] ) ) : ?>
                <div <?php echo ridez_elementor_get_render_attribute_string( 'subtitle', $this ); ?>>
                    <span><?php printf('%s', $settings['subtitle']); ?></span>
                </div>
            <?php endif; ?>

            <?php if ( ! empty( $settings['title'] ) ) : ?>
                <<?php echo esc_html($title_tag) . ' ' . ridez_elementor_get_render_attribute_string( 'title', $this ); ?>>
                <?php printf('%s', $settings['title']); ?>
                </<?php echo esc_html($title_tag); ?>>
            <?php endif; ?>

            <?php if ( ! empty( $settings['description'] ) ) : ?>
                <div <?php echo ridez_elementor_get_render_attribute_string( 'description', $this ); ?>>
            ...
            <div class="elementor-cta__button-wrapper elementor-cta__content-item elementor-content-item <?php echo esc_attr($animation_class); ?>">
                <<?php echo esc_html($button_tag) . ' ' . ridez_elementor_get_render_attribute_string( 'button', $this ); ?>>
                <span>
                    <?php echo esc_html($settings['button']); ?>
                </span>
                <?php if ( ! empty( $settings['icon'] ) || ! empty( $settings['selected_iconbutton']['value'] ) ) : ?>
                    <?php if ( $is_new || $migrated ) :
                        Icons_Manager::render_icon( $settings['selected_iconbutton'], [ 'aria-hidden' => 'true' ] );
                    else : ?>
...
$widgets_manager->register(new Ridez_Call_To_Action());
